...
class BallTestTwo extends Canvas implements Runnable
{
	...
	public BallTestTwo()
	{
		...
		ball = new Ball(100,100,50,50,Color.ORANGE,2,2);
		...
		System.out.println(ball.equals(new Ball(100,100,50,50,Color.ORANGE,2,2))); //should be false due to the change in xSpeed and ySpeed
		...
		ball = new Ball(100,100,50,50,Color.ORANGE);
		ball = new Ball(100,100,50,50,Color.ORANGE,10,10);
