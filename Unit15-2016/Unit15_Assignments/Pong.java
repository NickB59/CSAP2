...
//		ball = new SpeedUpBall(100,100,20,20,Color.ORANGE,5,5);
//		ball = new BlinkyBall(100,100,20,20,Color.ORANGE,5,5);
//		ball = new InvisibleBall(100,100,20,20,Color.ORANGE,5,5);
		
		leftPaddle = new Paddle(20,200,20,60,Color.RED,10);
		rightPaddle = new Paddle(750,100,20,60,Color.RED,10);
...
//				ball = new SpeedUpBall(400,300,20,20,Color.ORANGE,5,5);
			...
			if(!(ball.getX()<=right.getX()-right.getWidth())){
				...
				ball.remove(graphToBack);
				ball = new Ball(400,300,20,20,Color.ORANGE,5,5);
//				ball = new BlinkyBall(400,300,20,20,Color.ORANGE,5,5);
//				ball = new InvisibleBall(400,300,20,20,Color.ORANGE,5,5);
//				ball = new SpeedUpBall(400,300,20,20,Color.ORANGE,5,5);
			}
		}
