...
public class MadLib
{
	...
	{
		try{
			Scanner file = new Scanner(new File("C:\\Users\\bnick\\Desktop\\CSAP2\\Unit10-2016\\Unit10-Assignments\\Lab16d\\nouns.dat"));
			while(file.hasNext()){
				nouns.add(file.next());
			}
	...
	{
		try{
			Scanner file = new Scanner(new File("C:\\Users\\bnick\\Desktop\\CSAP2\\Unit10-2016\\Unit10-Assignments\\Lab16d\\verbs.dat"));
			while(file.hasNext()){
				verbs.add(file.next());
			}
	...
	{
		try{
			Scanner file = new Scanner(new File("C:\\Users\\bnick\\Desktop\\CSAP2\\Unit10-2016\\Unit10-Assignments\\Lab16d\\adjectives.dat"));
			while(file.hasNext()){
